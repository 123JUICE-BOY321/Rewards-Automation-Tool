...
os.system('start msedge --profile-directory="Default" https://www.bing.com/search?q=bing')
...
for i in range(n):
    ...
    pyautogui.sleep(sleep)
os.system('start msedge --profile-directory="Default" https://rewards.bing.com/')
